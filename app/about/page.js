    ...
    <div className="container mx-auto px-4 py-12 text-center text-gray-200">
      ...
      <section className="grid md:grid-cols-2 gap-10 items-center mb-12 max-w-5xl mx-auto">
        ...
        <div className="text-left bg-gray-800 p-8 rounded-lg shadow-2xl">
          ...
          <p className="text-lg leading-relaxed mb-4">
            We are a passionate team of food enthusiasts and tech innovators dedicated to building the best online recipe sharing experience. Our goal is to make it easy for you to find exactly what you Are looking for, experiment with new cuisines, and share your own culinary masterpieces with the world.
          </p>
          <p className="text-lg leading-relaxed">
            Every recipe tells a story, and we Are here to help you write yours. Join our community and embark on a delicious adventure!
          </p>
        </div>
      </section>
